...
const validations = {
  ...
  isExisty(values, value) {
    return helpers.isExisty(value);
  },
  matchRegexp(values, value, regexp) {
    return !helpers.isExisty(value) || helpers.isEmpty(value) || regexp.test(value);
  },
  ...
  isLength(values, value, length) {
    return !helpers.isExisty(value) || helpers.isEmpty(value) || value.length === length;
  },
  equals(values, value, eql) {
    return !helpers.isExisty(value) || helpers.isEmpty(value) || value === eql;
  },
  equalsField(values, value, field) {
    return value === values[field];
  },
  maxLength(values, value, length) {
    return !helpers.isExisty(value) || value.length <= length;
  },
